<template>
    <div class="Files">
        <p style="font-size: 20px; position: absolute; top: 62px;">我的收藏</p>
      ...
      <span class="el-dropdown-link">
        排序<i class="el-icon-arrow-down el-icon--right"></i>
                ...
                <el-dropdown-menu class="menu" slot="dropdown">
                    <el-button class="cusBottom" @click="sortBySizeAsc"><i class="el-icon-top"></i>大小</el-button>
                    <br>
                    <el-button class="cusBottom" @click="sortBySizeDesc"><i class="el-icon-bottom"></i>大小</el-button>
                    <br>
                    <el-button class="cusBottom" @click="sortByDateAsc"><i class="el-icon-top"></i>日期</el-button>
                    <br>
                    <el-button class="cusBottom" @click="sortByDateDesc"><i class="el-icon-bottom"></i>日期</el-button>
                </el-dropdown-menu>
            </el-dropdown>
            <el-input style="display:inline-block;width: 50%;" placeholder="搜索" suffix-icon="el-icon-research"
                      v-model="searchName"></el-input>
            <el-button style="display: inline-block; margin-left: 20px" icon="el-icon-search" type="primary" round
                       @click="toSearch">搜索
            </el-button>
                ...
                <el-dropdown trigger="click">
                    ...
                    <el-dropdown-menu slot="dropdown" class="menu" v-show="visible">
                        ...
                        <a :href="'http://182.84.10.33:8181/files/downloadFiles/1/'+ item.id" v-if="item.isimg">
                            <el-button class="cusBut" style="border:0; width: 100%; font-size: 16px;"
                                       @click="downloadimg"
                            ><i class="el-icon-download" style="padding-right: 2px;padding-left: -2px"></i> 下载
                            </el-button>
                        </a>
                        ...
                        <el-button class="cusBut" style="border:0; width: 100%; font-size: 16px"
                            ...
                            <i class="el-icon-collection-tag" style="padding-right: 2px;padding-left: -2px"></i> 收藏
                        </el-button>
                        <br>
                        <el-button class="cusBut" style="border:0; width: 100%; font-size: 16px" @click="open(item)">
                            <i class="el-icon-tickets" style="padding-right: 2px;padding-left: -2px"></i> 属性
                        </el-button>
                        <div class="lines"></div>
                        <el-button class="Del" style="border:0; width: 100%; font-size: 16px"
                                   @click="deleteById(item.id)">
                            <i class="el-icon-delete" style="padding-right: 2px;padding-left: -2px"></i> 删除
                        </el-button>
                    </el-dropdown-menu>
                </el-dropdown>
...
export default {
    ...
    created() {
        axios.get('http://182.84.10.33:8181/files/findAllCollects').then((resp) => {
            if (resp.data.success) {
                this.files = resp.data.message;
                for (const file of this.files) {
                    file.ordinaryUploadTime = Date.parse(file.uploadtime)
